...
namespace Blog.Core.Model.See
{
    public class FrameSeed
    {
        ...
        public static bool CreateControllers(SqlSugarClient sqlSugarClient, string path, string ConnId = null, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"{path}\Blog.Core\Controllers", "Blog.Core.Controllers", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateModels(SqlSugarClient sqlSugarClient, string path, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"{path}\Blog.Core.Model", "Blog.Core.Model.Models", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateIRepositorys(SqlSugarClient sqlSugarClient, string path, string ConnId, bool isMuti = false, string[] tableNames = null )
        {
            ...
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"{path}\Blog.Core.IRepository", "Blog.Core.IRepository", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateIServices(SqlSugarClient sqlSugarClient, string path, string ConnId, bool isMuti = false, string[] tableNames = null )
        {
            ...
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"{path}\Blog.Core.IServices", "Blog.Core.IServices", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateRepository(SqlSugarClient sqlSugarClient, string path, string ConnId, bool isMuti = false, string[] tableNames = null )
        {
            ...
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"{path}\Blog.Core.Repository", "Blog.Core.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        public static bool CreateServices(SqlSugarClient sqlSugarClient, string path, string ConnId, bool isMuti = false, string[] tableNames = null )
        {
            ...
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"{path}\Blog.Core.Services", "Blog.Core.Services", tableNames, "", isMuti);
            return true;
        ...
        {
            string sqlIsMuti = string.Empty;
            //多库文件分离
            if (isMuti)
            {
                strPath = strPath + @"\" + ConnId;
                strNameSpace = strNameSpace + "." + ConnId;
                sqlIsMuti = @"using Blog.Core.IServices." + strNameSpace + ";";
    }
