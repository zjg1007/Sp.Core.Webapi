...
namespace Blog.Core.Services.BASE
{
    public class BaseServices<TEntity> : IBaseServices<TEntity> where TEntity : class, new()
    {
        ...
        /// <returns></returns>
        public async Task<List<TResult>> SqlQuery<TResult>(string sql, params SugarParameter[] parameters) where TResult : class, new()
        {
            return  await BaseDal.SqlQuery<TResult>(sql, parameters);
        }
        /// <summary>
        /// 查询返回单条记录
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<List<TResult>> SqlQuery<TResult>(string sql, object whereObj = null) where TResult : class, new()
        {
            return await BaseDal.SqlQuery<TResult>(sql, whereObj);
        }
        /// <summary>
        /// 查询返回动态类型(该类型为Newtonsoft.Json里面的JObject类型, 使用方法自行百度)
        /// </summary>
        /// <typeparam name="TResult"></typeparam>
        /// <param name="sql"></param>
        /// <param name="parameters"></param>
        /// <returns></returns>
        public async Task<List<TResult>> SqlQuery<TResult>(string sql, List<SugarParameter> parameters) where TResult : class, new()
        {
            return await BaseDal.SqlQuery<TResult>(sql, parameters);
        }
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public async Task<TResult> SqlQuerySingleAsync<TResult>(string sql, List<SugarParameter> parameters)
        {
            return await BaseDal.SqlQuerySingleAsync<TResult>(sql, parameters);
        }
        public async Task<TResult> SqlQuerySingleAsync<TResult>(string sql, params SugarParameter[] parameters)
        {
            return await BaseDal.SqlQuerySingleAsync<TResult>(sql, parameters);
        }
        public async Task<TResult> SqlQuerySingleAsync<TResult>(string sql, object whereObj = null)
        {
            return await BaseDal.SqlQuerySingleAsync<TResult>(sql, whereObj);
        }
        /// <summary>
        /// 执行SQL返回受影响行数
        /// </summary>
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public async Task<int> ExecuteCommand(string sql, object parameters)
        {
            return await BaseDal.ExecuteCommand(sql, parameters);
        }

        public async Task<int> ExecuteCommand(string sql, params SugarParameter[] parameters)
        {
            return await BaseDal.ExecuteCommand(sql, parameters);
        }

        public async Task<int> ExecuteCommand(string sql, List<SugarParameter> parameters)
        {
            return await BaseDal.ExecuteCommand(sql, parameters);
        }
    }
