...
namespace Blog.Core.Repository.Base
{
    public class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class, new()
    {
        ...
        /// <returns></returns>
        public async Task<List<TResult>> SqlQuery<TResult>(
         string sql,
         params SugarParameter[] parameters) where TResult : class, new()
        {
        ...
        public async Task<List<TResult>> SqlQuery<TResult>(
    string sql,
    object whereObj = null) where TResult : class, new()
        {
            return await _db.Ado.SqlQueryAsync<TResult>(sql, whereObj);
        }
        /// <summary>
        ...
        public async Task<List<TResult>> SqlQuery<TResult>(
         string sql,
         List<SugarParameter> parameters) where TResult : class, new()
        {
            return await _db.Ado.SqlQueryAsync<TResult>(sql, parameters);
        }
        /// <summary>
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public async Task<T> SqlQuerySingleAsync<T>(string sql, List<SugarParameter> parameters)
        {
            return await _db.Ado.SqlQuerySingleAsync<T>(sql, parameters);
        }
        public async Task<T> SqlQuerySingleAsync<T>(string sql, params SugarParameter[] parameters)
        {
            return await _db.Ado.SqlQuerySingleAsync<T>(sql, parameters);
        }
        public async Task<T> SqlQuerySingleAsync<T>(string sql, object whereObj = null)
        {
            return await _db.Ado.SqlQuerySingleAsync<T>(sql, whereObj);
        }
        /// <summary>
        /// 执行SQL返回受影响行数
        /// </summary>
